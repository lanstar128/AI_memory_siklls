...
### 场景一：日常归档 (标准模式)
> **你**: "今天工作完成了，帮我保存一下对话。"
> **AI**: "好的，正在总结...已生成对话归档 `2026-01-19_fix-login-bug.md`，包含 3 个关键代码段和最终解决方案。已同步到远程仓库。"
...
### 场景三：经验沉淀
> **你**: "这个配置终于调通了，真不容易。"
> **AI**: "检测到调试过程较长，是否将 `Nginx WebSocket 配置方案` 沉淀为通用技能？这样下次我可以自动应用此配置。"
> **你**: "确认。"
> **AI**: "已创建技能 `nginx-websocket-config`。"
